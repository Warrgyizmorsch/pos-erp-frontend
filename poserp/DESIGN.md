...
| `/cash-bank/transaction-history` | `/cash-bank/history` | `cash_bank` | `CashBankController` | `CashBankRepository` | Transaction Table | Pending |
| `/bank` | `/bank` | `cash_bank/bank` | `BankController` | `BankRepository` | Account Cards + List | Pending |
| `/cash` | `/cash` | `cash_bank/cash` | `CashController` | `CashBankRepository` | Cash Ledger Table | Pending |
| `/cheques` | `/cheques` | `cash_bank/cheques` | `ChequeController` | `ChequeRepository` | Status Filtered Table | Pending |
| `/loans` | `/loans` | `cash_bank/loans` | `LoanController` | `LoanRepository` | Loan Account Cards | Pending |
| `/expenses` | `/expenses` | `expenses` | `ExpenseController` | `ExpenseRepository` | Category Filtered Table | Pending |
| `/expenses/income` | `/expenses/income` | `expenses/income` | `IncomeController` | `ExpenseRepository` | Income Entry Table | Pending |
