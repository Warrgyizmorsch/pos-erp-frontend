...
class ReceivablesReportView extends GetView<FinancialReportsController> {
  const ReceivablesReportView({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Receivables Report'),
        actions: [
          IconButton(
          ...
          children: [
            ...
            Expanded(
              child: Obx(() {
                ...
                final report = controller.receivables.value;
                if (report == null) {
                  ...
                  return const EmptyState(
                    ...
                    description:
                        'Select a valid date range to compute customer outstanding balances.',
                  );
                }
                ...
                return SingleChildScrollView(
                  ...
                  child: Column(
                    children: [
                      // Top 2 Metric Summary Cards Grid
                      LayoutBuilder(
                        builder: (context, constraints) {
                          final isMobile = constraints.maxWidth < 600;

                          final recWidget = _buildSummaryMetricCard(
                            'Total Receivable',
                      ...
                      LayoutBuilder(
                        builder: (context, constraints) {
                          ...
                          if (!isDesktop) {
                            return _buildMobileReceivablesList(report, isDark);
                          }

                          return _buildDesktopReceivablesTable(report, isDark);
                        },
                      ),
  ...
  Widget _buildDesktopReceivablesTable(
          ...
          children: [
            ...
            if (report.rows.isEmpty)
              const Padding(
                ...
                child: Text(
                  'No customer receivables recorded for period.',
              ...
              ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  final due = row.receivable > 0 ? row.receivable : row.advance;
                  final statusText = isAdv
                      ? 'Advance'
                      : (row.receivable > 0 ? 'Due' : 'Clear');
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    flex: 2,
                    child: Text(
                      '₹${report.totals.totalReceivable.toStringAsFixed(2)}',
                      textAlign: TextAlign.right,
                      style: const TextStyle(
                        fontSize: 12,
                        fontWeight: FontWeight.bold,
  ...
  Widget _buildMobileReceivablesList(
    PartyOutstandingReport report,
    bool isDark,
  ) {
    return Column(
