              ...
              Expanded(
                child: SingleChildScrollView(
                  child: Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      // Left Column: Supplier & Unpaid Bills
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                      ...
                      // Right Column: Date, Amount, Payment Mode, Bank Account & Ref
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            ...
                            AppTextField(
                              ...
                              controller:
                                  TextEditingController(
                                    ...
                                    ..selection = TextSelection.collapsed(
                                      offset:
                                          controller.referenceNo.value.length,
                                    ),
                              onChanged: (v) =>
                                  controller.referenceNo.value = v,
                            ),
                          ],
                        ),
                      ),
