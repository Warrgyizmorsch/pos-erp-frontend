...
export default function SaleReturnPage() {
  ...
  useEffect(() => {
    customerService.getAll({ limit: 500 }).then(r => setCustomers(r.data)).catch((err) => console.error("Failed to load data", err));
      ...
      {mode === "list" ? (
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="page-title">Issue Credit Note</h1>
              <p className="page-description mt-0.5">Process sold goods return and adjust balances</p>
            </div>
          </div>
